...
const Header = () => {
  return (
    <header>
      <div className="m-5 lg:m-0 lg:mt-[22px] max-w-[1148.75px] lg:mx-auto lg:h-[94px] bg-white rounded-[30px] p-3 lg:py-[23px] lg:px-[20px] border-[4px] border-action flex justify-between items-center lg:relative left-[20px] top-[-1px]">
